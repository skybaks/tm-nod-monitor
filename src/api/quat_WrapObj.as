...
namespace api
{
    funcdef quat quat_GetFunction();
    class quat_WrapObj : WatchTableMixin, IWatchTableObject
    {
        private quat_GetFunction@ m_getFunctionQuat;

        quat_WrapObj(quat_GetFunction@ getFunction, const string&in name, const string&in qualifiedName)
        {
            @m_getFunctionQuat = getFunction;
            m_name = name;
        ...
        {
            return tostring(m_getFunctionQuat());
        }
