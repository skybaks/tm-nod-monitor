...
namespace api
{
    funcdef mat3 mat3_GetFunction();
    class mat3_WrapObj : WatchTableMixin, IWatchTableObject
    {
        private mat3_GetFunction@ m_getFunctionMat3;

        mat3_WrapObj(mat3_GetFunction@ getFunction, const string&in name, const string&in qualifiedName)
        {
            @m_getFunctionMat3 = getFunction;
            m_name = name;
